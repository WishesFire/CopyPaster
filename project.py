...
# Class MyGuiWindow for Window
class MyGuiWindow(QtWidgets.QWidget):
    def __init__(self, parent = None):
        QtWidgets.QWidget.__init__(self, parent)
        self.setWindowFlags(QtCore.Qt.MSWindowsFixedSizeDialogHint | QtCore.Qt.FramelessWindowHint | QtCore.Qt.WindowStaysOnTopHint)
        ...
        self.setWindowIcon(QtGui.QIcon(str(self.path) + '\\images\\Icon2.png'))
        
        self.tray = QtWidgets.QSystemTrayIcon(self)
        self.tray.setIcon(QtGui.QIcon(str(self.path) + '\\images\\Icon2.png'))
